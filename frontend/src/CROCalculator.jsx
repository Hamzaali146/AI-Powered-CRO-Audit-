...
const CROCalculator = () => {
  ...
  const scanningSteps = [
    ...
    {
      text: "Analyzing page structure and layout...",
      duration: 2500,
      phase: "structure",
    },
    {
      text: "Checking mobile responsiveness...",
      duration: 2200,
      phase: "mobile",
    },
    {
      text: "Evaluating page load speed...",
      duration: 1800,
      phase: "performance",
    },
    {
      text: "Scanning conversion funnels...",
      duration: 2000,
      phase: "funnels",
    },
    {
      text: "Analyzing checkout process...",
      duration: 1900,
      phase: "checkout",
    },
    {
      text: "Checking trust signals and security...",
      duration: 1600,
      phase: "trust",
    },
    {
      text: "Reviewing user experience patterns...",
      duration: 2300,
      phase: "ux",
    },
    {
      text: "Running competitor analysis...",
      duration: 2400,
      phase: "competitors",
    },
    {
      text: "Calculating revenue opportunities...",
      duration: 1800,
      phase: "revenue",
    },
  ...
  const generateWebsiteScreenshot = () => {
    ...
    const domain = formData.website_url
      .replace(/https?:\/\//, "")
      .replace(/\/.*/, "");
    setWebsiteScreenshot(
      `https://api.screenshotmachine.com/?key=4eaebd&url=${encodeURIComponent(
      ...
      setTimeout(() => {
        ...
        if (currentCheckIndex < analysisChecks.length) {
          setCheckedItems((prev) => [
            ...prev,
            analysisChecks[currentCheckIndex],
          ]);
          currentCheckIndex++;
        }
        ...
        const mockResult = {
          ...
          current_metrics: {
            ...
            monthly_revenue: Math.round(
              parseInt(formData.monthly_visitors) *
                (parseFloat(formData.current_conversion_rate) / 100) *
                parseFloat(formData.average_order_value)
            ),
          },
          revenue_potential: {
            current_monthly_revenue: Math.round(
              parseInt(formData.monthly_visitors) *
                (parseFloat(formData.current_conversion_rate) / 100) *
                parseFloat(formData.average_order_value)
            ),
            potential_monthly_revenue: Math.round(
              parseInt(formData.monthly_visitors) *
                (parseFloat(formData.current_conversion_rate) / 100) *
                parseFloat(formData.average_order_value) *
                1.65
            ),
            monthly_revenue_uplift: Math.round(
              parseInt(formData.monthly_visitors) *
                (parseFloat(formData.current_conversion_rate) / 100) *
                parseFloat(formData.average_order_value) *
                0.65
            ),
            annual_revenue_uplift: Math.round(
              parseInt(formData.monthly_visitors) *
                (parseFloat(formData.current_conversion_rate) / 100) *
                parseFloat(formData.average_order_value) *
                0.65 *
          ...
          issues_found: [
            {
              ...
              description:
                "Your checkout has too many steps, causing 67% cart abandonment",
              potential_uplift: 23,
            },
            {
            ...
            },
            {
              ...
              description:
                "Lack of trust indicators reducing conversion confidence",
              potential_uplift: 12,
            },
            {
              ...
              description:
                "Customers can't examine products closely before buying",
              potential_uplift: 8,
            },
          ],
          competitor_analysis: [
  ...
  const submitContactInfo = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/contact?audit_id=${auditResult.audit_id}`,
        {
          method: "POST",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12 text-white">
              ...
              <h1 className="text-4xl font-bold mb-4">
                Your CRO Audit is Ready!
              </h1>
              <p className="text-xl text-gray-300">
                We've identified significant opportunities for growth
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 mb-8 shadow-2xl border border-gray-700">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-blue-900/20 rounded-lg border border-blue-800">
                  ...
                  <div className="text-2xl font-bold text-blue-400">
                    {auditResult.current_metrics.monthly_visitors.toLocaleString()}
                  </div>
                ...
                <div className="text-center p-4 bg-green-900/20 rounded-lg border border-green-800">
                  ...
                  <div className="text-2xl font-bold text-green-400">
                    {auditResult.current_metrics.conversion_rate}%
                  </div>
                ...
                <div className="text-center p-4 bg-purple-900/20 rounded-lg border border-purple-800">
                  ...
                  <div className="text-2xl font-bold text-purple-400">
                    ${auditResult.current_metrics.average_order_value}
                  </div>
                  <div className="text-sm text-gray-300">
                    Average Order Value
                  </div>
                ...
                <div className="text-center p-4 bg-yellow-900/20 rounded-lg border border-yellow-800">
                  ...
                  <div className="text-2xl font-bold text-yellow-400">
                    $
                    {auditResult.current_metrics.monthly_revenue.toLocaleString()}
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold">
                        $
                        {auditResult.revenue_potential.current_monthly_revenue.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold">
                        $
                        {auditResult.revenue_potential.potential_monthly_revenue.toLocaleString()}
                      </span>
                    </div>
                    <div className="border-t border-green-400 pt-3 flex justify-between items-center text-lg font-bold">
                      ...
                      <span>
                        +$
                        {auditResult.revenue_potential.monthly_revenue_uplift.toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-center p-6 bg-white/20 rounded-lg">
                    ...
                    <div className="text-sm mt-2 opacity-75">
                      {auditResult.revenue_potential.total_uplift_percentage}%
            ...
            <div className="bg-gray-800 rounded-2xl p-8 mb-8 shadow-2xl border border-gray-700">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center mb-2">
                          ...
                          <span
                            className={`ml-3 px-2 py-1 rounded text-xs font-bold ${getSeverityColor(
                              issue.severity
                            )}`}
                          >
                            {issue.severity}
              ...
              <div className="mt-6 p-4 bg-blue-900/20 rounded-lg border border-blue-800">
                <p className="text-sm text-blue-300">
                  <strong>
                    Found {auditResult.issues_found.length} total issues.
                  </strong>{" "}
                  The top 4 critical issues above represent your biggest
            ...
            <div className="bg-gray-800 rounded-2xl p-8 mb-8 shadow-2xl border border-gray-700">
              ...
              <p className="text-gray-300 mb-6">
                Your top competitors are significantly outperforming you:
              </p>
              <div className="grid gap-4">
                {auditResult.competitor_analysis.map((competitor, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center p-4 border border-gray-600 rounded-lg hover:bg-gray-700"
                  >
                    <div>
                      <div className="font-semibold text-white">
                        {competitor.name}
                      ...
                      <div className="text-sm text-gray-300">
                        {competitor.key_advantage}
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-bold text-green-400">
                        {competitor.conversion_rate}% CR
                      </div>
                      <div className="text-sm text-gray-400">
                        ${competitor.estimated_revenue.toLocaleString()}/mo
                        revenue
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-r from-orange-600 to-red-700 rounded-2xl p-8 text-white text-center shadow-2xl">
              <h2 className="text-3xl font-bold mb-4">
                ...
                {Math.round(
                  auditResult.revenue_potential.monthly_revenue_uplift / 1000
                )}
                K/mo Opportunity?
              </h2>
              ...
              <div className="bg-white/20 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold">
                      {auditResult.issues_found.length}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  {currentStep === 1 && (
                    <>
                      ...
                      {formData.monthly_visitors &&
                        formData.current_conversion_rate &&
                        formData.average_order_value && (
                      ...
                      <div className="grid gap-3">
                        {primaryGoals.map((goal, index) => (
                          <button
                            key={index}
                            onClick={() =>
                              handleInputChange("primary_goal", goal)
                            }
